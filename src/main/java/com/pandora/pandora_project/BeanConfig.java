...
//    }
    ...
    List<ProductDb> productDBThirdParty(){
        ...
        SubtaskDb subtask1aaQ4 = new SubtaskDb("S023", "Pengembangan fitur kategorisasi otomatis transaksi", "Done", new GregorianCalendar(2024, Calendar.OCTOBER, 17).getTime(), new GregorianCalendar(2024, Calendar.NOVEMBER, 30).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 20).getTime(), "U13"); // late 1 6
        SubtaskDb subtask1abQ4 = new SubtaskDb("S024", "Pembuatan grafik dan laporan pengeluaran", "Done", new GregorianCalendar(2024, Calendar.OCTOBER, 17).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 10).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 20).getTime(), "U13"); // late
        SubtaskDb subtask1acQ4 = new SubtaskDb("S025", "Implementasi fitur budgeting dan notifikasi jika anggaran terlampaui", "Done", new GregorianCalendar(2024, Calendar.OCTOBER, 17).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 15).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 20).getTime(), "U13"); // late
        SubtaskDb subtask1baQ4 = new SubtaskDb("S026", "Pengembangan sistem otorisasi transaksi antara MyBCA dan MyKripto", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 10).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 22).getTime(), "U13"); // late
        SubtaskDb subtask1bbQ4 = new SubtaskDb("S027", "Implementasi fitur pemilihan sumber dana dari rekening BCA yang berbeda", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 15).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 22).getTime(), "U13"); // late
        SubtaskDb subtask1bcQ4 = new SubtaskDb("S028", "Pengembangan mekanisme refund jika transaksi gagal", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 24).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 22).getTime(), "U13"); // on schedule
        SubtaskDb subtask1bdQ4 = new SubtaskDb("S029", "Pengujian user acceptance test (UAT) untuk memastikan kemudahan penggunaan", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 20).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 22).getTime(), "U13"); // late
        SubtaskDb subtask1caQ4 = new SubtaskDb("S030", "Pengembangan API untuk mengambil data portofolio dari MyKripto", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 15).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 25).getTime(), "U14"); // late 1 3
        SubtaskDb subtask1cbQ4 = new SubtaskDb("S031", "Pembuatan dashboard di MyBCA untuk menampilkan nilai aset kripto dalam Rupiah", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 18).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 25).getTime(), "U14"); // late
        SubtaskDb subtask1ccQ4 = new SubtaskDb("S032", "Implementasi fitur refresh otomatis untuk memperbarui data portofolio", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 28).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 30).getTime(), "U14"); // late
        SubtaskDb subtask1cdQ4 = new SubtaskDb("S033", "Pengembangan fitur notifikasi jika terjadi perubahan signifikan pada nilai portofolio", "Done", new GregorianCalendar(2024, Calendar.NOVEMBER, 3).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 27).getTime(), new GregorianCalendar(2024, Calendar.DECEMBER, 25).getTime(), "U14"); // on schedule
